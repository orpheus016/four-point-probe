...
def test_baseline_emits_snapshot_after_stable_window():
    b = BaselineBackbone(window_samples=4, std_threshold=0.02, min_stable_samples=2)
    ...
    # resistance = voltage / (current_mA/1000)
    expected = snapshot.voltage / (snapshot.current_mA / 1000.0)
